...
<head>
  ...
  <title>Meat Factory : Products Details</title>
  <!-- Bootstrap -->
...
<body>
    ...
    try {
      ...
      $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $stmt = $conn->prepare("SELECT * FROM tbl_products_a179904_pt2 WHERE fld_product_num = :pid");
...
<div class="col-xs-12 col-sm-5 col-md-12">
    <!-- <div class="col-xs-12 col-sm-5 col-sm-offset-2 col-md-10 col-md-offset-1"> -->
...
<tr>
        ...
        <tr>
          ...
          <td><?php echo $readrow['fld_product_organic'] ?></td>
        </tr>
        <tr>
