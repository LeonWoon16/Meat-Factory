...
<head>
  ...
  <title>Meat Factory : Customers</title>
  <!-- Bootstrap -->
 ...
 <div class="row">
    ...
    <form action="customers.php" method="post" class="form-horizontal">
      ...
      <div class="form-group">
          ...
          <div class="col-sm-9">
         <input name="email" type="text" class="form-control" id="customeremail" placeholder="Customer Email Address" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_customer_email']; ?>" required>
        </div>
        </div>  
      <div class="form-group">
...
<?php }?>
      ...
      try {
        ...
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
           $stmt = $conn->prepare("select * from tbl_customers_a179904_pt2 LIMIT $start_from, $per_page");
        $stmt->execute();
